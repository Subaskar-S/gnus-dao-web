  ...
  async (_, { getState, rejectWithValue }) => {
    ...
    try {
      ...
      return rejectWithValue(
        error.message || "Failed to initialize GNUS DAO service",
      );
    }
  },
);
...
export const refreshGnusDaoData = createAsyncThunk(
  ...
  async (_, { getState, rejectWithValue }) => {
    ...
    try {
      ...
      return rejectWithValue(
        error.message || "Failed to refresh GNUS DAO data",
      );
    }
  },
);
...
export const { setGnusDaoState, clearGnusDaoState, clearError } =
