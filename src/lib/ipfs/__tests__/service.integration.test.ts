...
const skipIfNoCredentials = () => {
  const hasCredentials = process.env.NEXT_PUBLIC_PINATA_JWT || 
...
describe('IPFS Service Integration', () => {
  ...
  describe('File Upload', () => {
    ...
    it('should handle upload progress callbacks', async () => {
      ...
      const file = new File(['Progress test content'], 'progress-test.txt', { type: 'text/plain' })
  ...
  describe('Proposal Metadata', () => {
    it('should upload and retrieve proposal metadata', async () => {
      ...
      const retrievedMetadata = await ipfsService.retrieveProposalMetadata(uploadResult.hash)
  ...
  describe('Content Retrieval', () => {
    ...
    beforeAll(async () => {
      ...
      const file = new File([testContent], 'retrieval-test.txt', { type: 'text/plain' })
    ...
    it('should throw error for invalid hash', async () => {
      ...
      await expect(
        ipfsService.retrieveContent('invalid-hash')
  ...
  describe('Content Pinning', () => {
    ...
    beforeAll(async () => {
      ...
      const file = new File([testContent], 'pinning-test.txt', { type: 'text/plain' })
    ...
    it('should throw error for invalid hash when pinning', async () => {
      ...
      await expect(
        ipfsService.pinContent('invalid-hash')
      ).rejects.toThrow('Invalid IPFS hash format')
    })
  })
  ...
  describe('Error Handling', () => {
    it('should handle file validation errors', async () => {
      ...
      await expect(
        ipfsService.uploadFile(largeFile)
      ).rejects.toThrow()
    })
    ...
    it('should handle unsupported file types', async () => {
      ...
      await expect(
        ipfsService.uploadFile(execFile)
      ).rejects.toThrow()
    })
  })
})
