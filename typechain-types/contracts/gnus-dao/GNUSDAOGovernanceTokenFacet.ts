...
export interface GNUSDAOGovernanceTokenFacetInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "UPGRADER_ROLE"
  ...
  encodeFunctionData(
    functionFragment: "getPastVotingPower",
    values: [AddressLike, BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "initializeGovernanceToken",
...
export interface GNUSDAOGovernanceTokenFacet extends BaseContract {
  connect(runner?: ContractRunner | null): GNUSDAOGovernanceTokenFacet;
  waitForDeployment(): Promise<this>;

  interface: GNUSDAOGovernanceTokenFacetInterface;
  ...
  getInitialSupply: TypedContractMethod<[], [bigint], "view">;
  ...
  initializeGovernanceToken: TypedContractMethod<
    [_name: string, _symbol: string, _initialOwner: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "getInitialSupply"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "getMaxSupply"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "getPastVotingPower"
  ): TypedContractMethod<
    [account: AddressLike, blockNumber: BigNumberish],
    [bigint],
    "view"
  ...
  >;
  getFunction(
    nameOrSignature: "initializeGovernanceToken"
  ): TypedContractMethod<
    [_name: string, _symbol: string, _initialOwner: AddressLike],
    [void],
    "nonpayable"
