...
export const metadata: Metadata = {
  ...
  description: 'Enterprise-grade decentralized governance platform with quadratic voting, multi-chain support, and Diamond pattern smart contracts.',
  keywords: [
    'DAO',
    'governance',
    'quadratic voting',
  ...
  openGraph: {
    ...
    description: 'Enterprise-grade decentralized governance platform with quadratic voting and multi-chain support.',
    siteName: 'GNUS DAO',
    images: [
      {
        url: '/og-image.png',
