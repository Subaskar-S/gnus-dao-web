      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Real-time statistics showcasing the power of our decentralized AI computing network and governance ecosystem
          </p>
        </div>
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 max-w-3xl mx-auto">
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-muted-foreground">Cost Savings vs Cloud</div>
          </div>
          <div className="text-center">
          ...
          <div className="text-center">
            <div className="text-2xl font-bold text-orange-500 mb-1">Global</div>
        ...
        <div className="mt-12 flex items-center justify-center space-x-2 text-sm text-muted-foreground">
          ...
          <span>Live network data updated every 30 seconds from GNUS.AI infrastructure</span>
        </div>
      </div>
    </section>
  )
