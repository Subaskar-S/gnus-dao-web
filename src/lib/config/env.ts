 ...
 * Lenient during build, strict at runtime for production functionality
 */
const envSchema = z.object({
  ...
  // RPC URLs - Always use defaults, allow override with environment variables
  NEXT_PUBLIC_ETHEREUM_RPC_URL: z.string().default('https://eth.llamarpc.com'),
  NEXT_PUBLIC_BASE_RPC_URL: z.string().default('https://mainnet.base.org'),
  NEXT_PUBLIC_POLYGON_RPC_URL: z.string().default('https://polygon-rpc.com'),
  NEXT_PUBLIC_SKALE_RPC_URL: z.string().default('https://mainnet.skalenodes.com/v1/elated-tan-skat'),
